...
public class act3apuntes {
    public static void main(String[] args) {
        ...
        //System.out.println("Último carácter: " + frase.charAt(100)); No se puede acceder al 100 porque está fuera de rango
        ...
        System.out.println("Comparando con equalsIgnoreCase: " + frase.equalsIgnoreCase(frase.toUpperCase())); //imprime true
        ...
        System.out.println("Posición de la primera y la última vez que aparece la palabra \"Jar\": " + frase.indexOf("Jar")+ " y " + frase.lastIndexOf("Jar") + " respectivamente.");
